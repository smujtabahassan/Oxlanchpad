...
<button className="inline-flex ml-2 justify-center items-center gap-2.5 pt-[0.4375rem] pb-[0.4375rem]  rounded-[0.625rem] md:w-[40%] w-[30%] border-2 border-[#db00c9] bg-[#121314] text-white text-center font-['Helvetica'] lg:text-[.9375rem] text-[.3375rem] font-bold ">
  UPCOMMING
</button>
<button className="inline-flex justify-center items-center gap-2.5 pt-[0.4375rem] pb-[0.4375rem]  rounded-[0.625rem] md:w-[40%] w-[30%] border-2 border-[#db00c9] bg-[#FFFFFF] text-black text-center font-['Helvetica'] lg:text-[.9375rem] text-[.3375rem] font-bold ">
 REFUNDABLE
</button>
...
<div><h1 className=' lg:text-[16px] sm:text-[6px] text-[6px] text-nowrap'>TARGETED RAISE </h1>
</div>

 <div className=' flex items-center  justify-center  gap-2 '><img src={usdticon} alt="" className='md:w-[20%] w-[10%] ' /> 
 <span className='lg:text-[16px] sm:text-[8px] text-[6px]'>USDT</span>  
 </div> <p className='lg:text-[16px] sm:text-[8px] text-[7px]'>0</p>  </div>

<div className='flex flex-col gap-2'>
    <div className='flex items-center justify-between   lg:text-[12px] text-[8px] font-semibold sm:w-[90%] w-[100%] mx-auto rounded-xl  '>
...
<div className=''><p className='lg:text-[12px] text-[8px]  ml-5 text-[#474847] '>Type </p>
</div>


<div><h1 className='lg:text-[12px] text-[8px]  ml-5  lg:text-[12px] text-[8px] font-semibold   text-nowrap'>PUBLIC</h1>
</div>



<div><h1 className='lg:text-[12px] text-[8px]  ml-5 text-[#474847]'>REGISTER PERIOD (FROM) </h1>
</div>
...
<div className='flex items-center justify-center'>
 <button className="   gap-2.5 pt-[0.4375rem] pb-[0.4375rem] text-center rounded-[0.625rem] w-[80%] border-2 border-[#db00c9] bg-[#121314] text-white  font-['Helvetica'] lg:text-[.9375rem] text-[.3375rem] font-bold ">
  Connect Wallet
</button>

</div>

<div><h1 className='lg:text-[12px] text-[8px]  ml-5 text-[#848584]'>REGISTRATION STARTS IN</h1>
</div>
...
<div className='flex flex-col rounded-xl  gap-5  p-5 lg:w-[60%] md:w-[40%] sm:w-[20%] w-[80%]  bg-[#1E1E1E] shadow-inner shadow-[#9629fc] drop-shadow-2xl'>
<div className=' relative'>
...
<div className=' flex ml-[1%] gap-10 '>
<button className="inline-flex ml-2 justify-center items-center gap-2.5 pt-[.4375rem] pb-[0.4375rem]  rounded-[0.625rem] md:w-[40%] w-[30%] border-2 border-[#db00c9] bg-[#121314] text-white text-center font-['Helvetica'] lg:text-[.9375rem] text-[.3375rem] font-bold ">
  UPCOMMING
</button>
<button className="inline-flex justify-center items-center gap-2.5 pt-[0.4375rem] pb-[0.4375rem]  rounded-[0.625rem] md:w-[40%] w-[30%] border-2 border-[#db00c9] bg-[#FFFFFF] text-black text-center font-['Helvetica'] lg:text-[.9375rem] text-[.3375rem] font-bold ">
 REFUNDABLE
