...
export const Frequentlyask = () => {
  ...
  return (
    <div className=' relative flex flex-col items-center h-auto text-[40px] p-10 font-bold'>
      ...
      <div className='flex justify-center  '>
        <div className='sm:w-[20%] w-[100%] mr-[5%]' >
          <img src={Faqboy} alt="" />
        </div>
    ...
    <div  className=" absolute gradient2 lg:w-[294.236px] md:w-[294.236px] w-[194.236px]  lg:h-[260px] md:h-[180px] h-[250px] top-[50%] left-[20%] z-[-10] "></div>
        ...
        <div className='flex flex-col space-y-2 text-[20px] mt-4 p-5 '>
          {data.map(item => (
            <div className='flex flex-col     ' onClick={() => toggleOpen(item.id)} key={item.id}>
              <button  className={`${item.open ? "p-2   rounded-[0.625rem]   w-[40%] border-2 border-[#db00c9] bg-[#121314] text-white text-center font-['Helvetica'] lg:text-[.8375rem] text-[.3375rem] font-bold ":"p-2   rounded-[0.625rem] md:w-[40%] w-[20%]  bg-[#121314] text-white text-center font-['Helvetica'] lg:text-[.8375rem] text-[.3375rem] font-bold " }`}>
