...
<div>
  ...
  <Link to="/">  <li className="  hover:bg-gradient-to-b  from-[#0400DB]    to-[#CD05FF]  hover:shadow-md    gap-2.5 p-2.5 p-2 w-[5.375rem] rounded-tl-[1.25rem] rounded-br-[1.25rem] ">Home</li></Link>
<Link to='/Tokenlanchpad'> <li className=" hover:bg-gradient-to-b  from-[#0400DB]    to-[#CD05FF]     hover:shadow-md gap-2.5 p-2.5 p-2  w-[7.375rem] rounded-tl-[1.25rem] rounded-br-[1.25rem] ">Nft_Launchpad</li></Link>
