...
export const CompletedProjects = () => {
  ...
  return (
    ...
    <div className='flex flex-col  items-center justify-center  mt-20  p-10  text-[40px] font-bold  '>
...
{ data.map((items,index)=>{return(
    ...
    <div key={index} className='flex flex-col   gap-5  border-2 sm:w-[90%] w-[100%] rounded-3xl  bg-[#1E1E1E] shadow-inner shadow-[#9629fc] drop-shadow-2xl'>
    ...
    <div className=' flex items-center ml-[4%]  md:gap-14 sm:gap-12 gap-2 lg:text-[14px] text-[10px] mt-4 '>
    <h3>CryotoEmpire:Match3-battle</h3>

    <button className={`cursor-pointer    sm:flex flex-col  justify-center items-center  hover:scale-75 transition-all ease-linear delay-75    mr-2  bg-black   text-[15px] font-bold   gap-2.5 p-2.5  lg:w-[108.81px] w-[10.375rem]  rounded-tl-[1.25rem] rounded-br-[1.25rem] `}>      <Link to="" className="link-to-dashboard  lg:text-[14px] text-[10px]">125 usd</Link>
    </button>
    ...
    <div className=''><p className='lg:text-[16px] text-[10px]  ml-5 text-[#BEB4B4] '>Total Raised </p>
    </div>
    
        <div className='flex items-center justify-between sm:gap-10 gap-2     lg:text-[12px] text-[10px] font-semibold sm:w-[90%] w-[100%] mx-auto rounded-xl  '>
    
    
    
       <div ><h1 className='ml-5 text-nowrap text-[#BEB4B4]'>51000 USD  <span className='text-[8px]'>FILLED</span></h1>
       </div>
     ...
     <div className='flex items-center sm:justify-between justify-center   lg:text-[16px] text-[14px]  gap-10   sm:w-[90%] w-[100%] mx-auto rounded-xl  '>
