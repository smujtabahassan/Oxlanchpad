...
<div className=' flex flex-col align-middle items-center mt-8 gap-10'>
...
<input type="text" className='mx-auto w-[90%] bg-transparent sm:text-start text-center  rounded-lg p-3 shadow-inner shadow-[#9629fc] drop-shadow-3xl border-gradient-pink-blue' value={'18'} />
...
<div class='flex items-center justify-center text-16 font-bold bg-gradient-to-r text-transparent bg-clip-text from-[#f966b9] via-[#0d93ec] to-[#5FFBF1] from-[45%] via-[50%] to-[55%] mt-10 cursor-pointer'><h1>Upload Logo</h1></div>
...
<div className='flex sm:flex-row flex-col items-center justify-center align-middle sm:gap-10 gap-1 '>
...
<div className='flex   flex-col items-center justify-center align-middle  sm:gap-4 gap-0 m-14  w-[40%]  text-16 font-bold  sm:mt-10 mt-0 text-white'>
...
<div class='flex flex-col items-center justify-center    text-16 font-bold  '>
...
<button className='sm:w-[50%] w-[100%] hover:scale-110 transition-all ease-linear delay-100   mx-auto  rounded-lg p-3 bg-gradient-to-b from-[#0400DB] to-[#CD05FF] shadow-inner shadow-[#9629fc] drop-shadow-3xl border-gradient-pink-blue sm:text-[15px] text-[8px]' placeholder='Token Name' >Mint A New Tokens</button>
...
<h1 className='font-semibold sm:text-[18px] text-[18px]'>Your Token</h1>
<p className='text-[14px]'>You have not minted any SPL Token yet.
All Tokens generated by your account will be shown here.</p>
</div>
<FaRotate  className='sm:text-[25px] text-[80px] hover:animate-spin'/>
